...
Figure~\ref{fig:entity-scores} shows precision, recall, and F1-scores for selected entity types (see end of document).
...
gold-standard labels and predicted labels. Figure~\ref{fig:entity-scores} summarizes 
